...
config_HadCM3 = importer('Experiments/HadCM3/Config_HadCM3_fixed.ini')
...
np.savetxt('Experiments/Output/HadCM3_P_20_resp_av_fix.txt', [P_HadCM3[-1], np.tile(gamma_HadCM3[-1], 6)],
           delimiter=',')
np.savetxt('Experiments/Output/HadCM3_F_20_resp_av_fix.txt', F_HadCM3, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_dF_20_resp_av_fix.txt', dF_HadCM3, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_ZMT_20_resp_av_fix.txt', data_HadCM3[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/HadCM3_GMT_20_resp_av_fix.txt', data_HadCM3[1][:, 0], delimiter=',')
...
np.savetxt('Experiments/Output/HadCM3_P_20_resp_s1_fix.txt', [P_HadCM3_s1[-1], np.tile(gamma_HadCM3_s1[-1], 6)],
           delimiter=',')
np.savetxt('Experiments/Output/HadCM3_F_20_resp_s1_fix.txt', F_HadCM3_s1, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_dF_20_resp_s1_fix.txt', dF_HadCM3_s1, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_ZMT_20_resp_s1_fix.txt', data_HadCM3_s1[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/HadCM3_GMT_20_resp_s1_fix.txt', data_HadCM3_s1[1][:, 0], delimiter=',')
...
np.savetxt('Experiments/Output/HadCM3_P_20_resp_s2_fix.txt', [P_HadCM3_s2[-1], np.tile(gamma_HadCM3_s2[-1], 6)],
           delimiter=',')
np.savetxt('Experiments/Output/HadCM3_F_20_resp_s2_fix.txt', F_HadCM3_s2, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_dF_20_resp_s2_fix.txt', dF_HadCM3_s2, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_ZMT_20_resp_s2_fix.txt', data_HadCM3_s2[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/HadCM3_GMT_20_resp_s2_fix.txt', data_HadCM3_s2[1][:, 0], delimiter=',')
...
np.savetxt('Experiments/Output/HadCM3_P_20_resp_s3_fix.txt', [P_HadCM3_s3[-1], np.tile(gamma_HadCM3_s3[-1], 6)],
           delimiter=',')
np.savetxt('Experiments/Output/HadCM3_F_20_resp_s3_fix.txt', F_HadCM3_s3, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_dF_20_resp_s3_fix.txt', dF_HadCM3_s3, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_ZMT_20_resp_s3_fix.txt', data_HadCM3_s3[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/HadCM3_GMT_20_resp_s3_fix.txt', data_HadCM3_s3[1][:, 0], delimiter=',')
...
config_CESM = importer('Experiments/CESM/Config_CESM_fixed.ini')
parallel_config = {'number_of_parameters': 6, 'number_of_cycles': 1, 'number_of_parallels': 13}
...
np.savetxt('Experiments/Output/CESM_P_20_resp_t_fix.txt', [P_CESM[-1], np.tile(gamma_CESM[-1], 6)], delimiter=',')
np.savetxt('Experiments/Output/CESM_F_20_resp_t_fix.txt', F_CESM, delimiter=',')
np.savetxt('Experiments/Output/CESM_dF_20_resp_t_fix.txt', dF_CESM, delimiter=',')
np.savetxt('Experiments/Output/CESM_ZMT_20_resp_t_fix.txt', data_CESM[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/CESM_GMT_20_resp_t_fix.txt', data_CESM[1][:, 0], delimiter=',')
...
np.savetxt('Experiments/Output/CESM_P_20_resp_dt_fix.txt', [P_CESM_dt[-1], np.tile(gamma_CESM_dt[-1], 6)],
           delimiter=',')
np.savetxt('Experiments/Output/CESM_F_20_resp_dt_fix.txt', F_CESM_dt, delimiter=',')
np.savetxt('Experiments/Output/CESM_dF_20_resp_dt_fix.txt', dF_CESM_dt, delimiter=',')
np.savetxt('Experiments/Output/CESM_ZMT_20_resp_dt_fix.txt', data_CESM_dt[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/CESM_GMT_20_resp_dt_fix.txt', data_CESM_dt[1][:, 0], delimiter=',')
...
config_Pages = importer('Experiments/Pages2k/Config_Pages_fixed.ini')
parallel_config = {'number_of_parameters': 6, 'number_of_cycles': 1, 'number_of_parallels': 13}
...
np.savetxt('Experiments/Output/Pages_P_20_resp_t_fix.txt', [P_Pages[-1], np.tile(gamma_Pages[-1], 6)], delimiter=',')
np.savetxt('Experiments/Output/Pages_F_20_resp_t_fix.txt', F_Pages, delimiter=',')
np.savetxt('Experiments/Output/Pages_dF_20_resp_t_fix.txt', dF_Pages, delimiter=',')
np.savetxt('Experiments/Output/Pages_ZMT_20_resp_t_fix.txt', data_Pages[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/Pages_GMT_20_resp_t_fix.txt', data_Pages[1][:, 0], delimiter=',')
...
np.savetxt('Experiments/Output/Pages_P_20_resp_dt_fix.txt', [P_Pages_dt[-1], np.tile(gamma_Pages_dt[-1], 6)],
           delimiter=',')
np.savetxt('Experiments/Output/Pages_F_20_resp_dt_fix.txt', F_Pages_dt, delimiter=',')
np.savetxt('Experiments/Output/Pages_dF_20_resp_dt_fix.txt', dF_Pages_dt, delimiter=',')
np.savetxt('Experiments/Output/Pages_ZMT_20_resp_dt_fix.txt', data_Pages_dt[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/Pages_GMT_20_resp_dt_fix.txt', data_Pages_dt[1][:, 0], delimiter=',')
...
np.savetxt('Experiments/Output/HadCM3_LGM_P_20_resp_an_fix.txt',
           [P_HadCM3_LGM_an[-1], np.tile(gamma_HadCM3_LGM_an[-1], 6)], delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_F_20_resp_an_fix.txt', F_HadCM3_LGM_an, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_dF_20_resp_an_fix.txt', dF_HadCM3_LGM_an, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_ZMT_20_resp_an_fix.txt', data_HadCM3_LGM_an[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_GMT_20_resp_an_fix.txt', data_HadCM3_LGM_an[1][:, 0], delimiter=',')
...
np.savetxt('Experiments/Output/HadCM3_LGM_P_20_abs_fix.txt', [P_HadCM3_LGM[-1], np.tile(gamma_HadCM3_LGM[-1], 6)],
           delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_F_20_abs_fix.txt', F_HadCM3_LGM, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_dF_20_abs_fix.txt', dF_HadCM3_LGM, delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_ZMT_20_abs_fix.txt', data_HadCM3_LGM[0][:, 0], delimiter=',')
np.savetxt('Experiments/Output/HadCM3_LGM_GMT_20_abs_fix.txt', data_HadCM3_LGM[1][:, 0], delimiter=',')
